...
interface EnhancedMascotGuideProps {
  couponsCount: number;
  activeFilter: string;
  isSearching: boolean;
  customTip?: Tip;
...
const EnhancedMascotGuide: React.FC<EnhancedMascotGuideProps> = ({
  couponsCount,
  activeFilter,
  isSearching,
  customTip
  ...
  // Collection of tips based on different states
  const tips: Tip[] = [
    {
      id: 'welcome',
      message: "Welcome to your coupon dashboard! I'm here to help you manage your offers.",
      mood: 'happy'
    },
    {
      id: 'create-first',
      message: "Create your first coupon to start attracting customers!",
      mood: 'excited'
    },
    {
      id: 'active-filter',
      message: "You're viewing your active coupons. These are currently available to your customers.",
      mood: 'helping'
    },
    {
      id: 'inactive-filter',
      message: "These are your inactive coupons. You can reactivate them anytime!",
      mood: 'thinking'
    },
    {
      id: 'many-coupons',
      message: "Wow! You've created quite a collection of coupons. Your customers must love you!",
      mood: 'celebrating'
    },
    {
      id: 'search-tip',
      message: "Looking for something specific? Try searching by coupon code or description.",
      mood: 'helping'
    },
    {
      id: 'no-results',
      message: "No coupons found. Try adjusting your filters or create a new coupon!",
      mood: 'thinking'
    }
  ];
  ...
  return (
    <div className="fixed bottom-4 right-4 z-20">
      <div className="relative">
        {/* Enhanced speech bubble with tip */}
        <AnimatePresence>
          {showTip && currentTip && (
            <motion.div
              className="absolute bottom-16 right-0 bg-white rounded-xl p-4 shadow-lg max-w-xs border border-amber-100"
        ...
        {/* Enhanced mascot button with animations */}
        <motion.button
          className="w-14 h-14 bg-gradient-to-br from-amber-400 to-rose-500 rounded-full shadow-lg flex items-center justify-center text-2xl"
...
export default EnhancedMascotGuide;