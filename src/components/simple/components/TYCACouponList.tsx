...
import TYCACouponCard from './TYCACouponCard';
import TYCAEmptyState from './TYCAEmptyState';
import { CouponData } from '../types/TYCATypes';

interface TYCACouponListProps {
  coupons: CouponData[];
...
const TYCACouponList: React.FC<TYCACouponListProps> = ({
  coupons,
  selectedCoupon,
  onSelectCoupon,
  onCopyCode,
