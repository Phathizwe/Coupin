...
import { fetchCustomerCoupons } from './services/couponService.enhanced.fixed';
...
const CouponsPage: React.FC = () => {
    ...
    const fetchBusinessDetails = async () => {
      if (businessId) {
        try {
          ...
          // Continue without business filter
        }
      } else {
  ...
  const fetchCoupons = async () => {
    ...
    try {
      ...
      // Fetch customer's coupons with improved error handling
